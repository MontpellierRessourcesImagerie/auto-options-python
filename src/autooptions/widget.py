...
class OptionsWidget(QWidget):
    ...
    def __init__(
        self, viewer, options, layout_type="default", client=None, sameRowSet=None
    ):
        """
    ...
    def _createLayout(self, layout_type):
        self.mainLayout = LayoutFactory.createLayout(
            layout_type=layout_type, same_row_set=self.sameRowSet, parent=self
        )
